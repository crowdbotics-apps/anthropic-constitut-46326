"""
Django settings for anthropic_constitut_46326 project.
...
ROOT_URLCONF = 'anthropic_constitut_46326.urls'
...
WSGI_APPLICATION = 'anthropic_constitut_46326.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "anthropic_constitut_46326 API",
    "DESCRIPTION": "API documentation for anthropic_constitut_46326 App",
    "VERSION": "v1",
}
